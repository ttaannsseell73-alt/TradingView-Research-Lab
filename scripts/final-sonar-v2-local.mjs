...
const acceptance = 'SONAR_SCALP_V2_ACCEPTANCE.json';
runNode('scripts/run-sonar-v2-acceptance.mjs', [oneCsv, fiveCsv, acceptance]);
...
if (publish) {
  ...
  run(git, ['commit', '-m', `evidence: SonarScalp v2 regime acceptance ${symbol}`]);
  ...
  console.log('SonarScalp V2 evidence committed and pushed.');
}
